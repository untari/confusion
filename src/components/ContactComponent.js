...
const isNumber = (val) => !isNaN(Number(val)); //update form data for postFeedback here 
const validEmail = (val) => /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(val); //and here
...
class Contact extends Component {
  ...
  handleSubmit(values) {
    this.props.postFeedback(values.firstname, values.lastname, values.telnum, values.email, values.agree, values.contactType, values.message);  //update form data using postFeedback//
